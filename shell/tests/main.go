...
import (
	...
	"github.com/IPFS-eX/go-ipfs-ex/shell"
...
func main() {
	...
	err := sh.Push("QmbPAjTuQ5wwH8qqomWY9EaTsCmp2j1KbkopV6FWHrKqwH", 3, false)
	if err != nil {
		fmt.Println("err:", err.Error())
	} else {
		fmt.Println("success to push:QmbPAjTuQ5wwH8qqomWY9EaTsCmp2j1KbkopV6FWHrKqwH")
	}
