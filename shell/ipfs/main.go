...
import (
	...
	corecmds "github.com/IPFS-eX/go-ipfs-ex/core/commands"
	corehttp "github.com/IPFS-eX/go-ipfs-ex/core/corehttp"
	loader "github.com/IPFS-eX/go-ipfs-ex/plugin/loader"
	repo "github.com/IPFS-eX/go-ipfs-ex/repo"
	fsrepo "github.com/IPFS-eX/go-ipfs-ex/repo/fsrepo"
	util "github.com/IPFS-eX/go-ipfs-ex/shell/ipfs/util"
...
var log = logging.Logger("shell/ipfs")
...
func MainStart(subCmd string) int {
	...
	for k, _ := range Root.Subcommands {
		if k == subCmd {
			os.Args = append(os.Args, subCmd)
		}
	}
