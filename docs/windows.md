...
cd %GOPATH%/src/github.com/IPFS-eX/go-ipfs-ex/cmd/ipfs
```
...
If you encounter a bug with `go-ipfs` itself (not related to building) please use the [issue tracker](https://github.com/IPFS-eX/go-ipfs-ex/issues) to report it.
