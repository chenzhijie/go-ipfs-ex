...
cd %GOPATH%/src/github.com/ETHFSx/go-ipfs/cmd/ipfs
```
...
If you encounter a bug with `go-ipfs` itself (not related to building) please use the [issue tracker](https://github.com/ETHFSx/go-ipfs/issues) to report it.
