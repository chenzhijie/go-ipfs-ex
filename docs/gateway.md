...
[config](https://github.com/IPFS-eX/go-ipfs-ex/blob/master/docs/config.md#gateway)
documentation.
...
`go-get=1` parameter. See [PR#3964](https://github.com/IPFS-eX/go-ipfs-ex/pull/3963)
for details</sub>
